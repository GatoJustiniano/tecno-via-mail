...
public class CompraDato {
    ...
    public CompraDato(int proveedor_id) {
        ...
        // Utilizar SimpleDateFormat para obtener la fecha en el formato deseado
        ...
        // Si la hora ajustada es menor que 10, añadir un 0 delante para mantener el formato "HH:mm:ss"
