...
public class PedidoDato {
    ...
    public PedidoDato(int usuario_id) {
        ...
        // Utilizar SimpleDateFormat para formatear la fecha y la hora
        ...
        // Si la hora ajustada es menor que 10, añadir un 0 delante
    ...
    public String getPedido(int pedido_id, int usuario_id, String nit) {
        try {
