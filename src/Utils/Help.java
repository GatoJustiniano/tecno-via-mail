...
public class Help {
    ...
    public static String getHelp() {
        return "<h1>FERRETERIA T&E - COMANDOS DISPONIBLES</h1>"
                + "<p>Para poder utilizar los comandos, debe enviar un correo a la direccion: <b> grupo03sc@tecnoweb.org.bo </b> con el siguiente formato:</p>"
                ...
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">CONFPEDIDO [NIT/CI: NUMBER, TIPO_PAGO: STRING (contado/credito)]</td> \n \n"
                + "</tr> \n \n"
                + "<tr> \n \n"
